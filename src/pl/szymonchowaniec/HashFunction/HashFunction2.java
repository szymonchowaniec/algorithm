...
//        while(minNumberToCheck>1){
//            if(isPrimeNumber(minNumberToCheck)){
//                return minNumberToCheck;
//            }
//            else minNumberToCheck++;
//
//        }
//        return 0;
    ...
    private String[] removeEmptySpacesInArray(String[] theArray) {
        int clearArraySize = 0;
        for (int i = 0; i <arraySize ; i++) {
            if(theArray[i]!="-1"){
                clearArraySize++;
            }
        }
        String[] clearArray = new String[clearArraySize];
        int counter = 0;
        for (int i = 0; i <arraySize ; i++) {
            if(theArray[i]!="-1"){
                clearArray[counter] = theArray[i];
                counter++;
            }
        }
        return clearArray;
